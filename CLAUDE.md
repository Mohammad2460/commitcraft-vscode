...
CommitCraft AI is a VS Code extension that generates professional git commit messages, PR descriptions, and changelog entries from staged diffs using Claude AI. It has a free tier (20 generations/month) and a Pro tier ($4.99/month, unlimited).
...
**Tech:** Next.js 14, TypeScript, Anthropic Claude Haiku, Supabase, Resend, Dodo (payments)
...
4. Backend validates key, checks quota, calls Claude Haiku
...
- Max diff size in prompts: 8KB (50KB accepted, truncated before sending to Claude)
...
- Claude model in use: `claude-haiku-4-5-20251001`
